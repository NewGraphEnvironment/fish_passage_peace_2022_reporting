...
### Tributary to Parsnip River - PSCIS crossing 6745
...
upstream from the confluence with the Parsnip River. At crossing `r as.character(my_site)`, `r fpr::fpr_my_pscis_info()` is a
...
[`r fpr::fpr_my_bcfishpass(col_pull = dbm_mof_50k_grid)`](`fpr::fpr_my_mapsheet(wshd = "parsnip", archive_date = "2022-05-27")`).
...
`r fpr::fpr_my_pscis_info()`, approximately
`r round(fpr::fpr_my_bcfishpass(col_pull = downstream_route_measure)*0.001, 1)`km
upstream from the confluence with the Parsnip River, at km 2.1 on the
`r fpr_my_pscis_info(col_pull = road_name)`. Canfor Corporation are the road tenure holders at this site. 
...
\@ref(tab:tab-wshd-125261)).  At the time of reporting, there was no fisheries information available within provincial databases for the area upstream of crossing `r as.character(my_site)`. A total of `r fpr::fpr_my_bcfishpass(col_pull = total_lakereservoir_ha)`ha of lake and `r fpr::fpr_my_bcfishpass(col_pull = total_wetland_ha)`ha of wetland are modelled upstream. This includes the Fern Lakes, a collection of three lakes that have a combined area of approximately 138ha. PSCIS crossing 198321 is located 700m upstream of crossing `r as.character(my_site)`. However, upon visiting this location, there was no ford or crossing found. This site appears to be the end of an ATV trail. Located a further 3.3km upstream of this site is the outlet of the first Fern lake. There is only one other crossing (ID 16601842) modelled before the lake on a ATV trail. No assessments have been done at this location, so the crossing type and barrier status are unknown at this time. However, it is unlikely that there is a crossing there due to the presence of deactivated crossings further downstream. Additionally, there is a modelled crossing located between the first and second lakes (ID 16600823), and one located between the second and third lakes (ID 16600822).   

<br>

A summary of habitat modelling outputs is presented in Table \@ref(tab:tab-culvert-bcfp-125261) and a map of the watershed is provided in map attachment [`r fpr::fpr_my_bcfishpass(col_pull = dbm_mof_50k_grid)`](`fpr::fpr_my_mapsheet(wshd = "parsnip", archive_date = "2022-05-27")`).
...
a maximum of `r fpr::fpr_my_wshd(col = 'elev_max')`m to
`r fpr::fpr_my_wshd(col = 'elev_min')`m near the crossing (Table
\@ref(tab:tab-wshd-125000)). There are no other stream crossings on this tributary that block fish passage. At the time of reporting, there was no fisheries information available within provincial databases for the area upstream of crossing `r as.character(my_site)`. A map of the watershed is provided in map attachment [93I.111](https://hillcrestgeo.ca/outgoing/fishpassage/projects/parsnip/archive/2022-05-27/FishPassage_093I.111.pdf).
...
This site was reassessed in 2021, with drone survey and fish sampling conducted. At the time of survey in 2021, PSCIS crossing `r as.character(my_site)` was
un-embedded, non-backwatered and ranked as a
