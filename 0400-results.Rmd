...
my_caption= 'Dashboard to facilitate field planning for field surveys. Note that only sites modelled as having 1km or more of bull trout rearing habitat (>1.5m channel width and <7.5% gradient). Full screen available through button in bottom right of map.'
