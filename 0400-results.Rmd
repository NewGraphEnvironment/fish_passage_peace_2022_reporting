...
proceeding to design for replacement. Modelling indicates  `r round(fpr::fpr_my_priority_info(col_pull= upstream_habitat_length_m)/1000)`km of habitat upstream of crossing `r as.character(my_site)` suitable for bull trout rearing with areas surveyed rated as `r fpr::fpr_my_priority_info(sit = my_site, loc = 'us', col_pull = hab_value)`
