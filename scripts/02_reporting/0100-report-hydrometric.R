...
########Parsnip River----------------------------------------------------------------------------------
# hydrometrics for Parsnip River (Parsnip River Above Misinchinka River Station #07EE007)
...
hydrograph4_stats_caption <- caption_info$title_stats
