...
##destination folder
dir_stub_target = '/Users/matwi/OneDrive/Projects/repo/fish_passage_peace_2022_reporting/photos_before_sort/MW'

##path to the photos
path <- '/Users/matwi/Projects/current/2022-050-sern-parsnip-fish-passage/data/photos/MW'
...
##sort mergin photos
##destination folder
dir_stub_target = '/Users/matwi/OneDrive/Projects/repo/fish_passage_peace_2022_reporting/photos_before_sort/mergin'

##path to the photos
path <- '/Users/matwi/Projects/current/2022-050-sern-parsnip-fish-passage/data/photos/mergin'
