...
```{r overview-map, fig.cap = 'Overview map of Study Area',eval=F}
...
```{r fish-gantt-morice, fig.cap = 'Gantt chart for select species in the Bulkley River watersheds.  To be updated in consultation with local fisheries techicians and knowledge holders.', eval=T}
